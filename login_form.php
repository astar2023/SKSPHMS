						...
						jQuery("#login_form1").submit(function(e){
								...
								$.ajax({
									...
									var delay = 1000;
										...
										$.jGrowl("SK SP HMS", { header: 'Access Granted' });
									var delay = 1000;
			...
			<hr>
				...
				<div class="pull-right">
					...
					<button data-placement="top" title="Sign In as Parent" id="signin_parent" onclick="window.location='signup_parent.php'" name="login" class="btn btn-info" type="submit">I`m a Parent &nbsp;</button>
				</div>
			</div>
														<script type="text/javascript">
														$(document).ready(function(){
