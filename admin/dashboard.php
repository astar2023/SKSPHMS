                ...
                <div class="span9" id="content">
                    ...
                    <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<?php 
								$query_reg_parent = mysqli_query($conn,"select * from parent where parent_status = 'Registered' ")or die(mysqli_error());
								$count_reg_parent = mysqli_num_rows($query_reg_parent);
								?>
								
                                <div class="span3">
                                    <div class="chart" data-percent="<?php echo $count_reg_parent; ?>"><?php echo $count_reg_parent; ?></div>
                                    <div class="chart-bottom-heading"><strong>Registered Parent</strong>

                                    </div>
                                </div>
								
								<?php 
								$query_parent = mysqli_query($conn,"select * from parent")or die(mysqli_error());
								$count_parent = mysqli_num_rows($query_parent);
								?>
								
								
                                <div class="span3">
                                    <div class="chart" data-percent="<?php echo $count_parent; ?>"><?php echo $count_parent ?></div>
                                    <div class="chart-bottom-heading"><strong>Parents</strong>
