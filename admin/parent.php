                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    ...
                                    <th></th>
										...
										<tbody>
												 <?php
                                    $parent_query = mysqli_query($conn,"select * from parent") or die(mysqli_error());
                                    while ($row = mysqli_fetch_array($parent_query)) {
                                    $id = $row['parent_id'];
                                    $parent_stat = $row['parent_stat'];
                                        ?>
									<tr>
										<td width="30">
									...
									<td width="50"><a href="edit_parent.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"></i></a></td>
									<?php if ($parent_stat == 'Activated' ){ ?>
									<td width="120"><a href="de_activate.php<?php echo '?id='.$id; ?>" class="btn btn-danger"><i class="icon-remove"></i> Deactivate</a></td>
									<?php }else{ ?>
									<td width="120"><a href="edit_parent.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-check"></i> Activated</a></td>				
									<?php } ?>
                                </tr>
                            <?php } ?>
