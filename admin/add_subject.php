		                        ...
		                        <div class="block">
									...
									<a href="subjects.php"><i class="icon-arrow-left"></i> Back</a>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" name="subject_code" id="inputEmail" placeholder="Subject Title">
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="inputPassword">Subject Code</label>
											<div class="controls">
											<input type="text" class="span8" name="title" id="inputPassword" placeholder="Subject Code" required>
											</div>
										</div>
