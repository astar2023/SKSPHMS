        ...
        <div class="container-fluid">
            <div class="row-fluid">
                     ...
                     <div class="row-fluid">
					   ...
					   <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Uploaded Homeworks</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
									...
									?>
									<div class="alert alert-info">Submit Homework in : <?php echo $row1['fname']; ?></div>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
						...
						LEFT JOIN student_assignment ON student.student_id = student_assignment.student_id AND assignment_id = '$post_id'
						WHERE class.class_id = '$class_id'
						ORDER BY student.lastname") or die(mysqli_error());
